                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>Đây là tên sẽ được hiển thị trên hồ sơ của bạn và trong email.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                                ...
                                <PopoverTrigger asChild>
                                    <FormControl>
                                        <Button variant={'outline'} className={cn('w-[240px] pl-3 text-left font-normal', !field.value && 'text-muted-foreground')}>
                                            {field.value ? format(field.value, 'MMM d, yyyy') : <span>Chọn một ngày</span>}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className='flex flex-col'>
                            ...
                            <FormDescription>Đây là ngôn ngữ sẽ được sử dụng trong bảng điều khiển.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
